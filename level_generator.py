...
#game window
tile_size = 50
Path = 'C:/git/python_project/pictures/'
cols = 20
margin = 100
...
#load images
sun_img = pygame.image.load(Path +'sun.png')
sun_img = pygame.transform.scale(sun_img, (tile_size, tile_size))
bg_img = pygame.image.load(Path +'sky.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load(Path +'dirt.png')
grass_img = pygame.image.load(Path +'grass.png')
blob_img = pygame.image.load(Path +'blob.png')
platform_x_img = pygame.image.load(Path +'platform_x.png')
platform_y_img = pygame.image.load(Path +'platform_y.png')
lava_img = pygame.image.load(Path +'lava.png')
coin_img = pygame.image.load(Path +'coin.png')
exit_img = pygame.image.load(Path +'exit.png')
save_img = pygame.image.load(Path +'save_btn.png')
load_img = pygame.image.load(Path + 'load_btn.png')
