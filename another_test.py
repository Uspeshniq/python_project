...
bulletSound = pygame.mixer.Sound('C:/git/python_project/sound effects/bullet.mp3')
hitSound = pygame.mixer.Sound('C:/git/python_project/sound effects/hit.mp3')

music = pygame.mixer.music.load('C:/git/python_project/sound effects/music.mp3')
...
class enemy(object):
    ...
    def __init__(self, x, y, width, height, end, spawn_interval):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
...
goblin = enemy(100, 410, 64, 64, 450, 1)
shootLoop = 0
bullets = []
goblins = []
run = True
while run:
    ...
    goblins = [goblin for goblin in goblins if goblin.visible]

    spawn_timer += 1
    if spawn_timer >= goblin.spawn_interval:
        spawn_timer = 0
        new_goblin_x = random.randint(50, 450)  
        new_goblin_y = 410  
        new_goblin = enemy(new_goblin_x, new_goblin_y, 64, 64, 450)  
